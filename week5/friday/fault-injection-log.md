...
Pipeline: `week5/friday/kijanikiosk-payment/Jenkinsfile`  
...
**Fault introduced:** Added a bare `<` character to `src/app.js` to produce an ESLint parse error.
...
**Fault introduced:** Uncommented the deliberate failure test in `test/payment.test.js`.
